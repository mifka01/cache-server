...
BinaryCacheRow: TypeAlias = tuple[str, str, str, str, str, int, int, str, str]  # id, name, url, token, access, port, retention, strategy, strategy_state
...
StrategyStateDict: TypeAlias = dict[str, str | int | List[str] | List[int]]
